...
var x = d3.scaleBand().rangeRound([0, width]).padding(0.0),
    ...
    color = d3.scaleOrdinal().domain(["n", "b"]).range(["#E8F5FD", "#FA7268"]);
...
function triangle1998 (){
    ...
    tooltip.transition()
        .duration(500)
        .style("opacity", 1)
        .attr("transform", "translate(" + (x(1998) - tooltipWidth/2.5) + "," + y(1.9) + ")")
        .on("end", function() {
            d3.select("#tooltip-text").text(1998);
        });
...
function triangle2002 (){
    ...
    .duration(500)
    .style("opacity", 1)
    .attr("transform", "translate(" + (x(2002) - tooltipWidth/2.5) + "," + y(1.9) + ")")
    .on("end", function() {
...
function triangle2016 (){
    ...
    .duration(500)
    .style("opacity", 1)
    .attr("transform", "translate(" + (x(2016) - tooltipWidth/2.5) + "," + y(1.9) + ")")
    .on("end", function() {
...
function triangle2017 (){
    ...
    .duration(500)
    .style("opacity", 1)
    .attr("transform", "translate(" + (x(2017) - tooltipWidth/2.5) + "," + y(1.9) + ")")
    .on("end", function() {
